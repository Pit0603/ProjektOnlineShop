<?php
    include("header.html");
?>
    <link rel="stylesheet" href="../css/styleIceDragonEgg.css">

        <video autoplay muted loop>
            <source src="../Video/SnowfallBackground3.mp4" type="video/mp4">
    ...
    <main>
        ...
        <div class="FireDragonSeite">
            <img
            src="../Bilder/IceDragonEggFrame.png"
            alt="This is a picture of a Ice-Dragon Egg"
            title="This is a picture of a Ice-Dragon-Egg"
            height="500" width="500">
                <div>
                    <h1>Ice-Dragon-Egg</h1>
        
                    <p>Ein Eisdrache ist ein mythisches Wesen, das in vielen Kulturen vorkommt.
                    ...
                    In vielen Geschichten wird der Feuerdrache als eine Art Kreatur dargestellt,
                     die in einer Höhle oder einem Berg lebt. Er bewacht oft einen Schatz oder ein Artefakt,
                      das von großer Bedeutung ist. In anderen Geschichten wird der Feuerdrache als eine Art Kreatur dargestellt,
                       ...
                       Erleben Sie die Hitze mit unseren brandneuen Eisdrachen, die Ihnen den Atem rauben werden!
