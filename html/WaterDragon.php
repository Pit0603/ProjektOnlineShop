...
<html lang="de">
    <head>
        ...
        <link rel="stylesheet" href="../css/styleWaterDragonEgg.css">
    ...
    <div class="FireDragonSeite">
            <img
            src="../Bilder/WaterDragonEggFrame.png"
            alt="This is a picture of a Water-Dragon Egg"
            title="This is a picture of a Water-Dragon-Egg"
            height="500" width="500">
                <div>
                    <h1>Water-Dragon-Egg</h1>
        
                    <p>Ein Wasserdrache ist ein mythisches Wesen, das in vielen Kulturen vorkommt.
                    ...
                    In vielen Geschichten wird der Feuerdrache als eine Art Kreatur dargestellt,
                     die in einer Höhle oder einem Berg lebt. Er bewacht oft einen Schatz oder ein Artefakt,
                      das von großer Bedeutung ist. In anderen Geschichten wird der Feuerdrache als eine Art Kreatur dargestellt,
                       ...
                       Erleben Sie die Hitze mit unseren brandneuen Wasserdrachen, die Ihnen den Atem rauben werden!
